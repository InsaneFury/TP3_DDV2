    ...
    void Update()
    {
        if (!GameManager.Instance.gameOver)
        {
            ...
            if (Input.GetButton("Fire2"))
            {
                ...
                crosshair.localScale = (new Vector3(0.8f, 0.8f, 1f));
            }
            else
            {
            ...
            //Animations
            if (bulletsToShoot <= 0f)
            {
                batteryOfGun.SetBool("noMoreAmmo", true);
            }
            else
            {
                batteryOfGun.SetBool("noMoreAmmo", false);
            }
        }
    }
